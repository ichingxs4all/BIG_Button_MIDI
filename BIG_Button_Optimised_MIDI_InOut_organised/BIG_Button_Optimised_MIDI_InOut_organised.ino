...
const bool debug = true; // Set this to true to output Serial port debug info
...
const int clock_pulse_length = 20;

const int midiClockDivider = 24;

int midiClock = 0;
long clock_timer = 0;
int knobVal, recordState,deleteState, clearState,resetState,fillState,bankButtonState;
...
void isr() {
  ...
  if(debug) Serial.println("CLOCK HIGH");
}
