...
For MIDI Channel 10, each MIDI KEY number ("NOTE#") corresponds to a different drum sound, as shown below. 
...
only these sounds are supported by General MIDI Level 1 devices.
